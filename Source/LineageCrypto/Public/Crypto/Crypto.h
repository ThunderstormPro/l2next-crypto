...
public:
	 ...
	 */
	static SLineageFileSchema Decrypt(const std::shared_ptr<LineageCryptoStreams::ReadableStream>& input,
									  const std::shared_ptr<LineageCryptoStreams::WritableStream>& output);
